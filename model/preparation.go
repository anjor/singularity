...
// ErrorLevel represents the severity level of an error log entry
...
type ErrorLog struct {
	...
	Level      ErrorLevel `gorm:"index"                             json:"level"`       // Error level (info, warning, error, critical)
	...
	Metadata   ConfigMap  `gorm:"type:json"                          json:"metadata"`   // Additional context as JSON
